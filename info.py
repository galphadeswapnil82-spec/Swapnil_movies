...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1003819199546'))
...
auth_channel = environ.get('AUTH_CHANNEL', '-1003769519400') # give your force subscribe channel id here else leave it blank
